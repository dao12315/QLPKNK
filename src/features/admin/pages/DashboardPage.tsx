      ...
      <aside className="w-64 bg-neutral-900 text-neutral-400 p-6 flex flex-col hidden md:flex">
        ...
        <nav className="flex-1 space-y-1">
          {[
            ...
            <button
              key={i}
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-colors ${item.active ? "bg-blue-600 text-white" : "hover:bg-neutral-800"}`}
            >
              {item.icon}
      ...
      <main className="flex-1 p-8 overflow-y-auto">
        <header className="flex justify-between items-center mb-8">
          ...
          <div className="flex items-center gap-4">
            <button className="px-4 py-2 bg-white border border-neutral-200 rounded-lg font-medium text-sm hover:bg-neutral-50">
              Generate Report
            </button>
              ...
              <table className="w-full text-left">
                <thead>
                  <tr className="text-neutral-400 text-xs uppercase tracking-wider border-b border-neutral-50">
                    <th className="pb-4 font-semibold text-neutral-500">
                      Patient
                    </th>
                    <th className="pb-4 font-semibold text-neutral-500">
                      Time
