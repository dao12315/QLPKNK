...
const PatientProfilePage = () => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      subtitle: "Record of past procedures",
          ...
          <div className="flex items-center gap-6">
            ...
            <div>
              ...
              <div className="mt-2 flex gap-2">
                ...
                <span className="px-2 py-0.5 bg-neutral-100 text-neutral-600 text-[10px] font-bold rounded-full uppercase tracking-wider">
                  Member Since 2026
                </span>
              </div>
            </div>
          ...
          {menuItems.map((item, i) => (
            ...
            >
              <div className="flex gap-4">
                <div className="p-3 bg-neutral-50 rounded-xl transition-colors group-hover:bg-neutral-100">
                  {item.icon}
                </div>
                <div>
        ...
        <section className="bg-blue-600 p-8 rounded-3xl text-white overflow-hidden relative shadow-xl shadow-blue-200">
          <div className="relative z-10">
            ...
            <p className="text-blue-100 text-sm max-w-sm mb-6">
              Connect with our specialists for a routine screening or specific
              dental concern.
            </p>
